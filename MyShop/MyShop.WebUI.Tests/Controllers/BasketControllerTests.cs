...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "Omar@gmail.com", ZipCode = "3021" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("Omar@gmail.com","Form"),null);
